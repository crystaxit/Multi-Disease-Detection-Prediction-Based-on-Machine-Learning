...
from stage import classify_brain as fs
import os
...
class Ui_stage1(object):
    ...
    def setupUii(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(850, 180, 220, 27))
...
######################################################################
        ...
        self.textEdit.setGeometry(QtCore.QRect(700, 50, 220, 31))
        
        self.textEdit.setStyleSheet(_fromUtf8("background-color: rgb(255,255,255);\n"
"color: rgb(0, 0, 0);"))
        self.textEdit.setObjectName(_fromUtf8("textEdit"))
        self.pushButton_2 = QtGui.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(550, 180, 220, 27))
...
"color: rgb(0, 0, 0);"))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(700, 120, 220, 27))
...
"color: rgb(0, 0, 0);"))
        ...
        self.label.setGeometry(QtCore.QRect(600, 60, 41, 17))
...
"color: rgb(0, 0, 0);"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Tumor Result", None))
    ...
    def classify(self):
        ...
        prec = cv2.imread("p3.jpg")
        cv2.imshow('Brain Tumor prevention', prec)
        cv2.waitKey(0)
