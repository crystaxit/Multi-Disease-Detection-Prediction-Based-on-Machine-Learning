...
from stage import classify_Lung as fs
import os
...
class Ui_stage(object):
    ...
    def setupUii(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(700, 180, 220, 27))
        ...
        self.textEdit.setGeometry(QtCore.QRect(550, 50, 220, 31))

        self.textEdit.setStyleSheet(_fromUtf8("background-color: rgb(255,255,255);\n"
                                              "color: rgb(0, 0, 0);"))
        self.textEdit.setObjectName(_fromUtf8("textEdit"))
        self.pushButton_2 = QtGui.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(400, 180, 220, 27))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(550, 120, 220, 27))
        ...
        self.label.setGeometry(QtCore.QRect(450, 60, 41, 17))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "View Stage", None))
    ...
    def classify(self):
       ...
       # res01=str_1.split(")")
        ...
        image = cv2.putText(img, res01, org1, font, fontScale, color, thickness, cv2.LINE_AA)
        image1 = cv2.putText(image, res02, org2, font, fontScale, color, thickness, cv2.LINE_AA)
        image2 = cv2.putText(image1, res03, org3, font, fontScale, color, thickness, cv2.LINE_AA)
        image3 = cv2.putText(image2, result, org4, font, fontScale, color, thickness, cv2.LINE_AA)

        # Displaying the image
        cv2.imshow('Score Window', image3)

        img1 = cv2.imread(fileName)
        # Window name in which image is displayed
        window_name = 'Lung cancer classification'
        ...
        prec = cv2.imread("p2.jpg")
        cv2.imshow('Lung cancer prevention', prec)
        cv2.waitKey(0)
